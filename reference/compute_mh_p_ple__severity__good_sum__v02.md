...
Computes the summary score `mh_p_ple__severity__good_sum__v02` Life
Events \[Parent\] (Severity of Good Events): Sum - Version 2 (Year 4 and
...
vars_mh_p_ple\_\_exp\_\_v02 is a character vector of all column names
