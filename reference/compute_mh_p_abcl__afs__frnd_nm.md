...
Computes the summary score `mh_p_abcl__afs__frnd_nm` Adult Behavior
Checklist \[Parent\] (Adaptive Functioning Scale - Friends): Number
missing
...
`vars_mh_p_abcl__afs__frnd` is vector of all column names used to
compute summary score of `mh_p_abcl__afs__frnd` scores.
