...
Computes the summary score `mh_y_ysr__dsm__dep_nm` Youth Self Report
\[Youth\] (DSM-5 Oriented Scale - Depressive problems): Number missing
...
`vars_mh_y_ysr__dsm__dep` is vector of all column names used to compute
summary score of `mh_y_ysr__dsm__dep` scores.
