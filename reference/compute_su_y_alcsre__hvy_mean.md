...
Computes the summary score `su_y_alcsre__hvy_mean` Alcohol Subject
Response and Effects \[Youth\] (Heaviest drinking period): Mean
...
vars_su_y_alcsre\_\_hvy is a character vector of all column names used
to compute summary scores of `compute_su_y_alcsre__hvy` (`_mean`,
`_count`, `_nm`).
