...
Computes the summary score `mh_p_cbcl__synd__othpr_nm` Child Behavior
...
`vars_mh_p_cbcl__synd__othpr` is vector of all column names used to
compute summary score of `mh_p_cbcl__synd__othpr` scores.
