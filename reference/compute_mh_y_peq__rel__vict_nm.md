...
Computes the summary score `mh_y_peq__rel__vict_nm` Peer Experiences
Questionnaire \[Youth\] (Relational Victimization): Number missing
...
`vars_mh_y_peq__rel__vict` is vector of all column names used to compute
summary score of `mh_y_peq__rel__vict` scores.
