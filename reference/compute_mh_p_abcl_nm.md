...
Computes the summary score `mh_p_abcl_nm` Adult Behavior Checklist
...
`vars_mh_p_abcl` is vector of all column names used to compute summary
score of `mh_p_abcl` scores.
