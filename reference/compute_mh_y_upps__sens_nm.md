...
Computes the summary score `mh_y_upps__sens_nm` Urgency, Premeditation,
Perseverance, Sensation Seeking, Positive Urgency, Impulsive Behavior
Scale (Short Version) \[Youth\] (Sensation Seeking): Number missing
...
`vars_mh_y_upps__sens` is vector of all column names used to compute
summary score of `mh_y_upps__sens` scores.
