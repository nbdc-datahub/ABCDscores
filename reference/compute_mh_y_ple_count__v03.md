...
Computes the summary score `mh_y_ple_count__v03` Life Events \[Youth\]
(Events): Count - Version 3 (Starting at Year 6) \[Validation: No more
...
vars_mh_y_ple\_\_v03 is a character vector of all column names used to
