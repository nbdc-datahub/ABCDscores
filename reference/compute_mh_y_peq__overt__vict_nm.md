...
Computes the summary score `mh_y_peq__overt__vict_nm` Peer Experiences
Questionnaire \[Youth\] (Overt Victimization): Number missing
...
`vars_mh_y_peq__overt__vict` is vector of all column names used to
compute summary score of `mh_y_peq__overt__vict` scores.
