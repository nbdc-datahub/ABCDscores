...
Computes the summary score `mh_p_abcl__synd__anxdep_nm` Adult Behavior
...
`vars_mh_p_abcl__synd__anxdep` is vector of all column names used to
compute summary score of `mh_p_abcl__synd__anxdep` scores.
