...
Computes the summary score `ph_p_sds__dims_sum` Sleep Disturbance Scale
\[Parent\] (Disorders of initiating and maintaining sleep): Sum
...
`ph_p_sds__dims_sum` and `ph_p_sds__dims_nm`.
