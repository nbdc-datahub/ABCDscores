...
Computes the summary score `mh_p_ple__severity__bad_sum__v04` Life
Events \[Parent\] (Severity of Bad Events): Sum - Version 4 (Starting at
Year 7) \[Validation: No more than 4 events missing and no
