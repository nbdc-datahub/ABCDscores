...
Computes the summary score `fc_y_vs__indselfrel_mean` (Values Scale
\[Youth\] (Independence and self-reliance): Mean)
...
vars_fc_y_vs\_\_indselfrel is a character vector of all column names
