...
Computes the summary score `mh_p_ksads__panic__pres__sx_mean` KSADS -
Panic Disorder \[Parent\] (Symptom - Present): Mean \[validation: No
...
vars_mh_p_ksads\_\_panic\_\_pres\_\_sx is a character vector of all
