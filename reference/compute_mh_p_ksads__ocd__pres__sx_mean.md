...
Computes the summary score `mh_p_ksads__ocd__pres__sx_mean` KSADS -
Obsessive Compulsive Disorder \[Parent\] (Symptom - Present): Mean
...
vars_mh_p_ksads\_\_ocd\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__ocd__pres__sx_mean`
