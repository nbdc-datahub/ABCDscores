...
Computes the summary score `ph_p_otbi__loc_count` Ohio State Traumatic
Brain Injury Screen \[Parent\] (Loss of consciousness): Count
...
vars_ph_p_otbi\_\_loc_count is a character vector of all column names
