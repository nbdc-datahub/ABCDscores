...
Computes the summary score `mh_y_ysr__dsm__dep_tscore` Youth Self Report
\[Youth\] (DSM-5 Oriented Scale - Depressive problems): T-score
...
- *Validation criterion:* maximally 2 of 11 items missing or
