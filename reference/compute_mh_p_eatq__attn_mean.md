...
Computes the summary score `mh_p_eatq__attn_mean` Early Adolescent
Temperament Questionnaire \[Parent\] (Attention): Mean
...
vars_mh_p_eatq\_\_attn is a character vector of all column names used to
compute summary score of `mh_p_eatq__attn_mean`.
