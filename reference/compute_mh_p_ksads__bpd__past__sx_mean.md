...
Computes the summary score `mh_p_ksads__bpd__past__sx_mean` KSADS -
Bipolar Disorders \[Parent\] (Symptom - Past): Mean \[validation: No
...
vars_mh_p_ksads\_\_bpd\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__bpd__past__sx_mean`
