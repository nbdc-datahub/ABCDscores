...
Computes the summary score `mh_p_asr__synd__som_nm` Adult Self Report
\[Parent\] (Syndrome Scale - Somatic complaints): Number missing
...
`vars_mh_p_asr__synd__som` is vector of all column names used to compute
summary score of `mh_p_asr__synd__som` scores.
