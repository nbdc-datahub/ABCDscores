...
Computes the summary score `fc_y_vs__ref_mean` (Values Scale \[Youth\]
...
vars_fc_y_vs\_\_ref is a character vector of all column names used to
compute summary score of `fc_y_vs__ref`.
