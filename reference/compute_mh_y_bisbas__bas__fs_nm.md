...
Computes the summary score `mh_y_bisbas__bas__fs_nm` The Behavioral
...
`vars_mh_y_bisbas__bas__fs` is vector of all column names used to
compute summary score of `mh_y_bisbas__bas__fs` scores.
