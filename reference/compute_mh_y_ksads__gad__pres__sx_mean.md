...
Computes the summary score `mh_y_ksads__gad__pres__sx_mean` KSADS -
Generalized Anxiety Disorder \[Youth\] (Symptom - Present): Mean
...
vars_mh_y_ksads\_\_gad\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__gad__pres__sx_mean`
