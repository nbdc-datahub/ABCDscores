...
Computes the summary score `mh_p_ksads__dmdd__sx_mean` KSADS -
Disruptive Mood Dysregulation Disorder \[Parent\] (Symptom): Mean
...
vars_mh_p_ksads\_\_dmdd\_\_sx is a character vector of all column names
used to compute summary score of `mh_p_ksads__dmdd__sx_mean`
