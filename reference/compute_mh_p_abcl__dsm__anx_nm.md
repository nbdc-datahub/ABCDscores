...
Computes the summary score `mh_p_abcl__dsm__anx_nm` Adult Behavior
Checklist \[Parent\] (DSM-5 Oriented Scale - Anxiety problems): Number
missing
...
`vars_mh_p_abcl__dsm__anx` is vector of all column names used to compute
summary score of `mh_p_abcl__dsm__anx` scores.
