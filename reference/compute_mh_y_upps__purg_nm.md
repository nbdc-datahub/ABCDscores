...
Computes the summary score `mh_y_upps__purg_nm` Urgency, Premeditation,
Perseverance, Sensation Seeking, Positive Urgency, Impulsive Behavior
Scale (Short Version) \[Youth\] (Positive Urgency): Number missing
...
`vars_mh_y_upps__purg` is vector of all column names used to compute
summary score of `mh_y_upps__purg` scores.
