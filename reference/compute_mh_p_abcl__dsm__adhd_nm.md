...
Computes the summary score `mh_p_abcl__dsm__adhd_nm` Adult Behavior
...
`vars_mh_p_abcl__dsm__adhd` is vector of all column names used to
compute summary score of `mh_p_abcl__dsm__adhd` scores.
