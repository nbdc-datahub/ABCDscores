...
Computes the summary score `su_y_mjexp__neg_prsum` Marijuana
Expectancies (MEEQ-B) \[Youth\] (Strength of negative expectancies):
...
vars_su_y_mjexp\_\_neg is a character vector of all column names used to
compute summary score of `su_y_mjexp__neg_prsum` and
`su_y_mjexp__neg_nm`.
