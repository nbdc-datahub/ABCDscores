...
Computes the summary score `mh_p_ksads__bpd__pres__sx_mean` KSADS -
Bipolar Disorders \[Parent\] (Symptom - Present): Mean \[Validation: No
...
vars_mh_p_ksads\_\_bpd\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__bpd__pres__sx_mean`
