...
Computes the summary score `mh_p_ksads__asd__pres__sx_mean` KSADS -
Autism Spectrum Disorders \[Parent\] (Symptom - Present): Mean
...
vars_mh_p_ksads\_\_asd\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__asd__pres__sx_mean`
