...
Computes the summary score `su_p_ksads__aud__past__sx_mean` KSADS -
Alcohol Use Disorder \[Parent\] (Symptom - Past): Mean \[Validation: No
...
vars_su_p_ksads\_\_aud\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `su_p_ksads__aud__past__sx_mean`
