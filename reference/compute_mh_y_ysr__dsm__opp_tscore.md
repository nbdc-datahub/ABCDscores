...
Computes the summary score `mh_y_ysr__dsm__opp_tscore` Youth Self Report
\[Youth\] (DSM-5 Oriented Scale - Oppositional Defiant problems):
T-score
...
- *Validation criterion:* maximally 1 of 5 items missing or
