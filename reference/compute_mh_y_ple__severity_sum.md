...
Computes the summary score `mh_y_ple__severity_sum` Life Events
\[Youth\] (Severity): Sum \[Validation: No more than 5 events missing
...
vars_mh_y_ple\_\_severity is a character vector of all column names used
to compute summary score of `mh_y_ple__severity`.
