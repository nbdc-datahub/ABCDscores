...
Computes the summary score `mh_y_ysr__synd__attn_nm` Youth Self Report
\[Youth\] (Syndrome Scale - Attention problems): Number missing
...
`vars_mh_y_ysr__synd__attn` is vector of all column names used to
compute summary score of `mh_y_ysr__synd__attn` scores.
