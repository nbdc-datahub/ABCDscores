...
Computes the summary score `mh_p_ksads__sleep__past__sx_mean` KSADS -
Sleep Problems \[Parent\] (Symptom - Past): Mean \[validation: No more
...
vars_mh_p_ksads\_\_sleep\_\_past\_\_sx is a character vector of all
