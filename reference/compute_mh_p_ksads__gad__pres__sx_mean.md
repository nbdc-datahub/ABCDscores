...
Computes the summary score `mh_p_ksads__gad__pres__sx_mean` KSADS -
Generalized Anxiety Disorder \[Parent\] (Symptom - Present): Mean
...
vars_mh_p_ksads\_\_gad\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__gad__pres__sx_mean`
