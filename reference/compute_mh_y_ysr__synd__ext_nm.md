...
Computes the summary score `mh_y_ysr__synd__ext_nm` Youth Self Report
\[Youth\] (Syndrome Scale - External): Number missing
...
`vars_mh_y_ysr__synd__ext` is vector of all column names used to compute
summary score of `mh_y_ysr__synd__ext` scores.
