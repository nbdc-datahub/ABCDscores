...
Computes the summary score `mh_p_abcl__synd__wthdr_nm` Adult Behavior
Checklist \[Parent\] (Syndrome Scale - Withdrawn): Number missing
...
`vars_mh_p_abcl__synd__wthdr` is vector of all column names used to
compute summary score of `mh_p_abcl__synd__wthdr` scores.
