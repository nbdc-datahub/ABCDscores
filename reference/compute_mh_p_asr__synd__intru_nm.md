...
Computes the summary score `mh_p_asr__synd__intru_nm` Adult Self Report
\[Parent\] (Syndrome Scale - Intrusive): Number missing
...
`vars_mh_p_asr__synd__intru` is vector of all column names used to
compute summary score of `mh_p_asr__synd__intru` scores.
