...
Computes the summary score `mh_y_ysr__dsm__opp_nm` Youth Self Report
\[Youth\] (DSM-5 Oriented Scale - Oppositional Defiant problems): Number
missing
...
`vars_mh_y_ysr__dsm__opp` is vector of all column names used to compute
summary score of `mh_y_ysr__dsm__opp` scores.
