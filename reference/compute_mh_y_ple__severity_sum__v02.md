...
Computes the summary score `mh_y_ple__severity_sum__v02` Life Events
\[Youth\] (Severity): Sum - Version 2 (Year 4 and Year 5) \[Validation:
...
vars_mh_y_ple\_\_severity\_\_v02 is a character vector of all column
