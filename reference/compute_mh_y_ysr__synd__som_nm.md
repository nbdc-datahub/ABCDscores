...
Computes the summary score `mh_y_ysr__synd__som_nm` Youth Self Report
\[Youth\] (Syndrome Scale - Somatic complaints): Number missing
...
`vars_mh_y_ysr__synd__som` is vector of all column names used to compute
summary score of `mh_y_ysr__synd__som` scores.
