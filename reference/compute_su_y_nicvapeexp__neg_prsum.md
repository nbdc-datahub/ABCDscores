...
Computes the summary score `su_y_nicvapeexp__neg_prsum` ENDS
Expectancies \[Youth\] (Strength of negative expectancies): Prorated sum
...
vars_su_y_nicvapeexp\_\_neg is a character vector of all column names
