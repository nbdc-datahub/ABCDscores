...
Computes the summary score `mh_p_ple__severity_sum__v01` Life Events
\[Parent\] (Severity): Sum - Version 1 (Year 3) \[Validation: No more
...
vars_mh_p_ple\_\_severity\_\_v01 is a character vector of all column
