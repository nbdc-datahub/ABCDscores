...
Computes the summary score `mh_p_eatq__actv_mean` Early Adolescent
Temperament Questionnaire \[Parent\] (Activation): Mean
...
vars_mh_p_eatq\_\_actv is a character vector of all column names used to
compute summary score of `mh_p_eatq__actv_mean`.
