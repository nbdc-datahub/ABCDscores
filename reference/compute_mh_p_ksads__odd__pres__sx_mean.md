...
Computes the summary score `mh_p_ksads__odd__pres__sx_mean` KSADS -
Oppositional Defiant Disorder \[Parent\] (Symptom - Present): Mean
...
vars_mh_p_ksads\_\_odd\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__odd__pres__sx_mean`
