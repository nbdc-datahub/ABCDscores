...
Computes the summary score `su_y_nicsre__vape_sum` Nicotine Subjective
Response and Effects \[Youth\] (Intensity of positive and negative
effects of first vape use): Sum - Negative score inverted \[Validation:
...
vars_su_y_nicsre\_\_vape is a character vector of all column names used
to compute summary scores of `compute_su_y_nicsre__vape` (`_sum`,
`_nm`).
