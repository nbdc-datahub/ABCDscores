...
Computes the summary score `su_y_caff__energy_sum` Caffeine Use
Questionnaire \[Youth\] (Energy): Sum \[Validation: None\]
...
vars_su_y_caff\_\_energy is a character vector of all column names used
