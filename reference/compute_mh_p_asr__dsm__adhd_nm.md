...
Computes the summary score `mh_p_asr__dsm__adhd_nm` Adult Self Report
\[Parent\] (DSM-5 Oriented Scale - ADHD): Number missing
...
`vars_mh_p_asr__dsm__adhd` is vector of all column names used to compute
summary score of `mh_p_asr__dsm__adhd` scores.
