...
Computes the summary score `mh_p_cbcl__synd__som_nm` Child Behavior
...
`vars_mh_p_cbcl__synd__som` is vector of all column names used to
compute summary score of `mh_p_cbcl__synd__som` scores.
