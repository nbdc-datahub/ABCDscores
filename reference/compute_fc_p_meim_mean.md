...
Computes the summary score `fc_p_meim_mean` (The Multigroup Ethnic
Identity Measure-Revised \[Parent\]: Mean)
...
vars_fc_p_meim is a character vector of all column names used to compute
summary score of `fc_p_meim`.
