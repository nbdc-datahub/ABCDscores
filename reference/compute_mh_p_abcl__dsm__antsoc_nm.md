...
Computes the summary score `mh_p_abcl__dsm__antsoc_nm` Adult Behavior
...
`vars_mh_p_abcl__dsm__antsoc` is vector of all column names used to
compute summary score of `mh_p_abcl__dsm__antsoc` scores.
