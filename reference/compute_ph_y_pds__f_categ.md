...
Computes the summary score `ph_y_pds__f_categ` Pubertal Development
Scale & Menstrual Cycle Survey History \[Youth\] (Female): Approximate
...
compute summary score of `ph_y_pds__f_categ` and
