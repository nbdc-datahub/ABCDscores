...
Computes the summary score `mh_p_ksads__hom__pres__sx_mean` KSADS -
Homicidality \[Parent\] (Symptom - Present): Mean \[validation: No more
...
vars_mh_p_ksads\_\_hom\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__hom__pres__sx_mean`
