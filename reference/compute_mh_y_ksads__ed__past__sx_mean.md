...
Computes the summary score `mh_y_ksads__ed__past__sx_mean` KSADS -
Eating Disorders \[Youth\] (Symptom - Past): Mean \[Validation: No more
...
vars_mh_y_ksads\_\_ed\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__ed__past__sx_mean`
