...
Computes the summary score `mh_y_ksads__bpd__past__sx_mean` KSADS -
Bipolar Disorders \[Youth\] (Symptom - Past): Mean \[Validation: No more
...
vars_mh_y_ksads\_\_bpd\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__bpd__past__sx_mean`
