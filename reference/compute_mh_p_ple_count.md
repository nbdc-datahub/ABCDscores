...
Computes the summary score `mh_p_ple_count` Life Events \[Parent\]
...
vars_mh_p_ple is a character vector of all column names used to compute
summary score of `mh_p_ple`.

vars_mh_p_ple\_\_exp is a character vector of all column names used to
compute summary score of `mh_p_ple__exp`.
