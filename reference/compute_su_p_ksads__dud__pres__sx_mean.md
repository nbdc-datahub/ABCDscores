...
Computes the summary score `su_p_ksads__dud__pres__sx_mean` KSADS - Drug
Use Disorders \[Parent\] (Symptom - Present): Mean \[Validation: No more
...
vars_su_p_ksads\_\_dud\_\_pres\_\_sx_mean is a character vector of all
