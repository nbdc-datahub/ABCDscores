...
Computes the summary score `mh_p_ple__severity_sum__v02` Life Events
\[Parent\] (Severity): Sum - Version 2 (Year 4 and Year 5) \[Validation:
...
vars_mh_p_ple\_\_severity\_\_v02 is a character vector of all column
