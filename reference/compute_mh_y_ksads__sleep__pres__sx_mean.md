...
Computes the summary score `mh_y_ksads__sleep__pres__sx_mean` KSADS -
Sleep Problems \[Youth\] (Symptom - Present): Mean \[Validation: No more
...
vars_mh_y_ksads\_\_sleep\_\_pres\_\_sx is a character vector of all
