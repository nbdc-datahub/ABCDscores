...
Computes the summary score `mh_p_abcl__su__drunk_nm` Adult Behavior
Checklist \[Parent\] (Days Drunk): Number missing
...
`vars_mh_p_abcl__su__drunk` is vector of all column names used to
compute summary score of `mh_p_abcl__su__drunk` scores.
