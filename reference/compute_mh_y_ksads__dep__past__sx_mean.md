...
Computes the summary score `mh_y_ksads__dep__past__sx_mean` KSADS -
Depressive Disorders \[Youth\] (Symptom - Past): Mean \[Validation: No
...
vars_mh_y_ksads\_\_dep\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__dep__past__sx_mean`
