...
Computes the summary score `mh_p_ksads__tic__past__sx_mean` KSADS - Tic
Disorders \[Parent\] (Symptom - Past): Mean \[validation: No more than 0
missing or declined\]
...
vars_mh_p_ksads\_\_tic\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__tic__past__sx_mean`
