...
Computes the summary score `mh_y_ple__severity_sum__v03` Life Events
\[Youth\] (Severity): Sum - Version 3 (Starting at Year 6) \[Validation:
No more than 6 events missing and no severity items missing or
declined\]
...
vars_mh_y_ple\_\_severity\_\_v03 is a character vector of all column
names used to compute summary score of `mh_y_ple__severity`.
