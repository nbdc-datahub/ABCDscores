...
Computes the summary score `mh_p_ple__severity__good_sum__v01` Life
Events \[Parent\] (Severity of Good Events): Sum - Version 1 (Year 3)
\[Validation: No more than 6 events missing and no experience/severity
...
vars_mh_p_ple\_\_exp\_\_v01 is a character vector of all column names
