...
Computes the summary score `ph_p_sds__swtd_sum` Sleep Disturbance Scale
\[Parent\] (Sleep-wake transition disorders): Sum \[Validation: No more
...
`ph_p_sds__swtd_sum` and `ph_p_sds__swtd_nm`.
