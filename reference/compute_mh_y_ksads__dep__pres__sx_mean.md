...
Computes the summary score `mh_y_ksads__dep__pres__sx_mean` KSADS -
Depressive Disorders \[Youth\] (Symptom - Present): Mean \[Validation:
...
vars_mh_y_ksads\_\_dep\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__dep__pres__sx_mean`
