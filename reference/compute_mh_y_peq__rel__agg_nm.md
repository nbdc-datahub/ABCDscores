...
Computes the summary score `mh_y_peq__rel__agg_nm` Peer Experiences
Questionnaire \[Youth\] (Relational Aggression): Number missing
...
`vars_mh_y_peq__rel__agg` is vector of all column names used to compute
summary score of `mh_y_peq__rel__agg` scores.
