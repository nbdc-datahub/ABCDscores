...
Computes the summary score `su_y_caff__suppl_sum` Caffeine Use
Questionnaire \[Youth\] (Caffeine supplements): Sum \[Validation: None\]
...
vars_su_y_caff\_\_suppl is a character vector of all column names used
