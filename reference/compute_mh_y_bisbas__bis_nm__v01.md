...
Computes the summary score `mh_y_bisbas__bis_nm__v01` The Behavioral
Inhibition System/Behavioral Activation System Scales \[Youth\] (BIS
(modified)): Number missing
...
`vars_mh_y_bisbas__bis__v01` is vector of all column names used to
compute summary score of `mh_y_bisbas__bis__v01` scores.
