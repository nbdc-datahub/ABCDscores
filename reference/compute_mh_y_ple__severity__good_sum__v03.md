...
Computes the summary score `mh_y_ple__severity__good_sum__v03` Life
Events \[Youth\] (Severity of Good Events): Sum - Version 3 (Starting at
Year 6) \[Validation: No more than 6 events missing and no
...
vars_mh_y_ple\_\_exp\_\_v03 is a character vector of all column names
