...
Computes the summary score `mh_p_asr__synd__int_nm` Adult Self Report
\[Parent\] (Syndrome Scale - Internalizing): Number missing
...
`vars_mh_p_asr__synd__int` is vector of all column names used to compute
summary score of `mh_p_asr__synd__int` scores.
