...
Computes the summary score `mh_y_ysr__dsm__adhd_nm` Youth Self Report
\[Youth\] (DSM-5 Oriented Scale - ADHD): Number missing
...
`vars_mh_y_ysr__dsm__adhd` is vector of all column names used to compute
summary score of `mh_y_ysr__dsm__adhd` scores.
