...
Computes the summary score `mh_p_cbcl__synd__tho_nm` Child Behavior
Checklist \[Parent\] (Syndrome Scale - Thought problems): Number missing
...
`vars_mh_p_cbcl__synd__tho` is vector of all column names used to
compute summary score of `mh_p_cbcl__synd__tho` scores.
