...
Computes the summary score `mh_p_ksads__sleep__pres__sx_mean` KSADS -
Sleep Problems \[Parent\] (Symptom - Present): Mean \[validation: No
...
vars_mh_p_ksads\_\_sleep\_\_pres\_\_sx is a character vector of all
