...
Computes the summary score `su_y_mjsre__pos_sum` Marijuana Subjective
Response and Effects \[Youth\] (Positive): Sum \[Validation: None
missing or declined\]
...
vars_su_y_mjsre\_\_pos is a character vector of all column names used to
compute summary scores of `compute_su_y_mjsre__pos` (`_sum`, `_nm`).
