...
Computes the summary score `mh_p_eatq__fear_mean` Early Adolescent
Temperament Questionnaire \[Parent\] (Fear): Mean
...
vars_mh_p_eatq\_\_fear is a character vector of all column names used to
compute summary score of `mh_p_eatq__fear_mean`.
