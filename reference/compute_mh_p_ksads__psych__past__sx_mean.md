...
Computes the summary score `mh_p_ksads__psych__past__sx_mean` KSADS -
Psychosis \[Parent\] (Symptom - Past): Mean \[validation: No more than 1
missing or declined\]
...
vars_mh_p_ksads\_\_psych\_\_past\_\_sx is a character vector of all
