...
Computes the summary score `mh_y_ksads__dmdd__sx_mean` KSADS -
Disruptive Mood Dysregulation Disorder \[Youth\] (Symptom): Mean
...
vars_mh_y_ksads\_\_dmdd\_\_sx is a character vector of all column names
used to compute summary score of `mh_y_ksads__dmdd__sx_mean`
