...
Computes the summary score `mh_p_ple__severity_sum` Life Events
\[Parent\] (Severity): Sum \[Validation: No more than 5 events missing
...
vars_mh_p_ple\_\_severity is a character vector of all column names used
to compute summary score of `mh_p_ple__severity`.
