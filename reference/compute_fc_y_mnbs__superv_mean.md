...
Computes the summary score `fc_y_mnbs__superv_mean` (Multidimensional
Neglectful Behavior Scale \[Youth\] (Supervision): Mean)
...
vars_fc_y_mnbs\_\_superv is a character vector of all column names used
to compute summary score of `fc_y_mnbs__superv`.
