...
Computes the summary score `mh_p_cbcl__dsm__somat_nm` Child Behavior
...
`vars_mh_p_cbcl__dsm__somat` is vector of all column names used to
compute summary score of `mh_p_cbcl__dsm__somat` scores.
