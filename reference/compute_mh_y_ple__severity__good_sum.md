...
Computes the summary score `mh_y_ple__severity__good_sum` Life Events
\[Youth\] (Severity of Good Events): Sum \[Validation: No more than 5
...
vars_mh_y_ple\_\_exp is a character vector of all column names used to
compute summary score of `mh_y_ple__exp`.
