...
Computes the summary score `mh_p_asr_nm` Adult Self Report \[Parent\]:
Number missing
...
`vars_mh_p_asr` is vector of all column names used to compute summary
score of `mh_p_asr` scores.
