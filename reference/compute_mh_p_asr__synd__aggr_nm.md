...
Computes the summary score `mh_p_asr__synd__aggr_nm` Adult Self Report
\[Parent\] (Syndrome Scale - Aggressive Behavior): Number missing
...
`vars_mh_p_asr__synd__aggr` is vector of all column names used to
compute summary score of `mh_p_asr__synd__aggr` scores.
