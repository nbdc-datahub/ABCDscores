...
Computes the summary score `mh_p_eatq__depm_mean` Early Adolescent
Temperament Questionnaire \[Parent\] (Depressive Mood): Mean
...
vars_mh_p_eatq\_\_depm is a character vector of all column names used to
compute summary score of `mh_p_eatq__depm_mean`.
