...
Computes the summary score `mh_y_ksads__ocd__past__sx_mean` KSADS -
Obsessive Compulsive Disorder \[Youth\] (Symptom - Past): Mean
...
vars_mh_y_ksads\_\_ocd\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_y_ksads__ocd__past__sx_mean`
