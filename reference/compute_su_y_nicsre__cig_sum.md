...
Computes the summary score `su_y_nicsre__cig_sum` Nicotine Subjective
Response and Effects \[Youth\] (Intensity of positive and negative
effects of first cigarette use): Sum - Negative score inverted
...
vars_su_y_nicsre\_\_cig is a character vector of all column names used
to compute summary scores of `compute_su_y_nicsre__cig` (`_sum`, `_nm`).
