...
Computes the summary score `su_y_caff__espres_sum` Caffeine Use
Questionnaire \[Youth\] (Espresso): Sum \[Validation: None\]
...
vars_su_y_caff\_\_espres is a character vector of all column names used
