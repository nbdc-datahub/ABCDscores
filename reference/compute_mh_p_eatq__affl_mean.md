...
Computes the summary score `mh_p_eatq__affl_mean` Early Adolescent
Temperament Questionnaire \[Parent\] (Affiliation): Mean
...
vars_mh_p_eatq\_\_affl is a character vector of all column names used to
compute summary score of `mh_p_eatq__affl_mean`.
