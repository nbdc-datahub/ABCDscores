...
Computes the summary score `mh_y_upps__pers_nm` Urgency, Premeditation,
Perseverance, Sensation Seeking, Positive Urgency, Impulsive Behavior
Scale (Short Version) \[Youth\] (Lack of Perseverance (GSSF)): Number
missing
...
`vars_mh_y_upps__pers` is vector of all column names used to compute
summary score of `mh_y_upps__pers` scores.
