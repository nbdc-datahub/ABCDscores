...
Computes the summary score `mh_y_ple__severity__good_sum__v01` Life
Events \[Youth\] (Severity of Good Events): Sum - Version 1 (Year 3)
...
vars_mh_y_ple\_\_exp\_\_v01 is a character vector of all column names
