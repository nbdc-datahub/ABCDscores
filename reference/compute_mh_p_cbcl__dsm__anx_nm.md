...
Computes the summary score `mh_p_cbcl__dsm__anx_nm` Child Behavior
Checklist \[Parent\] (DSM-5 Oriented Scale - Anxiety): Number missing
...
`vars_mh_p_cbcl__dsm__anx` is vector of all column names used to compute
summary score of `mh_p_cbcl__dsm__anx` scores.
