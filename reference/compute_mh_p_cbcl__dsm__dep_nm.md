...
Computes the summary score `mh_p_cbcl__dsm__dep_nm` Child Behavior
...
`vars_mh_p_cbcl__dsm__dep` is vector of all column names used to compute
summary score of `mh_p_cbcl__dsm__dep` scores.
