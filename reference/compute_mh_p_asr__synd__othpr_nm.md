...
Computes the summary score `mh_p_asr__synd__othpr_nm` Adult Self Report
\[Parent\] (Syndrome Scale - Other problems): Number missing
...
`vars_mh_p_asr__synd__othpr` is vector of all column names used to
compute summary score of `mh_p_asr__synd__othpr` scores.
