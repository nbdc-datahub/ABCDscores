...
Computes the summary score `mh_p_ple__exp__good_count__v02` Life Events
\[Parent\] (Experience Good Events): Count - Version 2 (Year 4 and Year
5) \[Validation: No more than 6 events missing and no experience items
missing or declined\]
