...
Computes the summary score `ab_g_stc__cohort_ethnrace__leg` Cohort
description: Ethno-racial identity (Legacy ABCD variable reporting 6
levels; Hispanic ethnicity report outweighs any racial endorements)
