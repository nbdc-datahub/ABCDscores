...
Computes the summary score `mh_p_ksads__gad__past__sx_mean` KSADS -
Generalized Anxiety Disorder \[Parent\] (Symptom - Past): Mean
...
vars_mh_p_ksads\_\_gad\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__gad__past__sx_mean`
