...
Computes the summary score `mh_p_ple__severity_sum__v04` Life Events
\[Parent\] (Severity): Sum - Version 4 (Starting at Year 7)
...
vars_mh_p_ple\_\_severity\_\_v04 is a character vector of all column
