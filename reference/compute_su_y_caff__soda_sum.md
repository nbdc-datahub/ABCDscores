...
Computes the summary score `su_y_caff__soda_sum` Caffeine Use
Questionnaire \[Youth\] (Soda) : Sum \[Validation: None\]
...
vars_su_y_caff\_\_soda is a character vector of all column names used to
compute `compute_su_y_caff__soda_sum`.
