...
Computes the summary score `mh_p_abcl__dsm__avoid_nm` Adult Behavior
...
`vars_mh_p_abcl__dsm__avoid` is vector of all column names used to
compute summary score of `mh_p_abcl__dsm__avoid` scores.
