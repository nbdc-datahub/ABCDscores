...
Computes the summary score `mh_p_ksads__asd__past__sx_mean` KSADS -
Autism Spectrum Disorders \[Parent\] (Symptom - Past): Mean
...
vars_mh_p_ksads\_\_asd\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__asd__past__sx_mean`
