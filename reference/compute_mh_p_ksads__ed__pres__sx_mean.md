...
Computes the summary score `mh_p_ksads__ed__pres__sx_mean` KSADS -
Eating Disorders \[Parent\] (Symptom - Present): Mean \[validation: No
...
vars_mh_p_ksads\_\_ed\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__ed__pres__sx_mean`
