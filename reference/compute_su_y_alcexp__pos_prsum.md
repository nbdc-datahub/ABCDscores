...
Computes the summary score `su_y_alcexp__pos_prsum` Alcohol Expectancies
(AEQ-AB) \[Youth\] (Strength of positive expectancies): Prorated sum
...
vars_su_y_alcexp\_\_pos is a character vector of all column names used
to compute summary score of `su_y_alcexp__pos_prsum` and
`su_y_alcexp__pos_nm`.
