...
Computes the summary score `su_p_ksads__aud__pres__sx_mean` KSADS -
Alcohol Use Disorder \[Parent\] (Symptom - Present): Mean \[Validation:
...
vars_su_p_ksads\_\_aud\_\_pres\_\_sx is a character vector of all column
names used to compute summary score of `su_p_ksads__aud__pres__sx_mean`
