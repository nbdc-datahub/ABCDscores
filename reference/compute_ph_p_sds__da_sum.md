...
Computes the summary score `ph_p_sds__da_sum` Sleep Disturbance Scale
\[Parent\] (Disorder of arousal): Sum \[Validation: No more than 0
missing or declined\]
...
`ph_p_sds__da_sum` and `ph_p_sds__da_nm`.
