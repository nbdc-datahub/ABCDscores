# Compute "Values Scale \[Parent\] (Familism): Mean - Baseline to Year 5"

Computes the summary score `fc_p_vs__famil_mean` (Values Scale
\[Parent\] (Familism): Mean - Baseline to Year 5)
...
`fc_p_vs__famil_mean` and `fc_p_vs__famil_nm`.
