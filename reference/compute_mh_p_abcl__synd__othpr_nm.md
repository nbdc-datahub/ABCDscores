...
Computes the summary score `mh_p_abcl__synd__othpr_nm` Adult Behavior
Checklist \[Parent\] (Syndrome Scale - Other problems): Number missing
...
`vars_mh_p_abcl__synd__othpr` is vector of all column names used to
compute summary score of `mh_p_abcl__synd__othpr` scores.
