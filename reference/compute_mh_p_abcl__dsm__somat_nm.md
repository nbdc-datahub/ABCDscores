...
Computes the summary score `mh_p_abcl__dsm__somat_nm` Adult Behavior
Checklist \[Parent\] (DSM-5 Oriented Scale - Somatic complaints): Number
missing
...
`vars_mh_p_abcl__dsm__somat` is vector of all column names used to
compute summary score of `mh_p_abcl__dsm__somat` scores.
