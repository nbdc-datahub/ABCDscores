...
Computes the summary score `mh_p_ksads__ed__past__sx_mean` KSADS -
Eating Disorders \[Parent\] (Symptom - Past): Mean \[validation: No more
than 1 missing or declined\]
...
vars_mh_p_ksads\_\_ed\_\_past\_\_sx is a character vector of all column
names used to compute summary score of `mh_p_ksads__ed__past__sx_mean`
