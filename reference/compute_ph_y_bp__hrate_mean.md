...
Computes the summary score `ph_y_bp__hrate_mean` Blood Pressure
\[Youth\] (Heart rate): Mean
...
vars_ph_y_bp\_\_hrate is a character vector of all column names used to
compute summary scores of `ph_y_bp__hrate`.
