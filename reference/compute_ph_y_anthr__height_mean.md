...
Computes the summary score `ph_y_anthr__height_mean` Anthropometrics
\[Youth\] (Height): Mean
...
vars_ph_y_anthr\_\_height is a character vector of all column names used
to compute summary scores of `ph_y_anthr__height`.
