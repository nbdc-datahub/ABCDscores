...
Computes the summary score `mh_y_peq__overt__agg_nm` Peer Experiences
Questionnaire \[Youth\] (Overt Aggression): Number missing
...
`vars_mh_y_peq__overt__agg` is vector of all column names used to
compute summary score of `mh_y_peq__overt__agg` scores.
