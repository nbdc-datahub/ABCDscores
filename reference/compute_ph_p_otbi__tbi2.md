...
Computes the summary score `ph_p_otbi__tbi2` Ohio State Traumatic Brain
Injury Screen \[Parent\]: Possible mild TBI
...
vars_ph_p_otbi\_\_tbi2 is a character vector of all column names used to
compute summary score of `ph_p_otbi__tbi2`.
