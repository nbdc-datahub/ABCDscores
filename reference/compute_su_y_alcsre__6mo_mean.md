...
Computes the summary score `su_y_alcsre__6mo_mean` Alcohol Subject
Response and Effects \[Youth\] (Last 6 months): Mean \[Validation: None
missing or declined\]
...
vars_su_y_alcsre\_\_6mo is a character vector of all column names used
to compute summary scores of `compute_su_y_alcsre__6mo` (`_mean`,
`_count`, `_nm`).
