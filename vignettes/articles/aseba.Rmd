...
vignette: >
  %\VignetteIndexEntry{Achenbach System of Empirically Based Assessment (ASEBA) T-scores}
...
- `col_sex`: character, specifies the column name in the input data that
  contains the participants' sex. This information is required to look up the
  sex-specific T-score. For example, for score
...
- *row 5:* because the sum of the raw scores (2 + 5 = 7) exceeds the range
  [0, 4].
