...
- `compute_tlfb_totdose_sum()`: Compute sum total dose of substance use.
...
- `wknd`: Whether the score should be computed only for weekend days, only for week days, or all days
...
Not all parameters are used by all functions and some parameters are mutually exclusive (see the function documentation for more details). The following gives an overview of which function can use which parameter:
...
tribble(
  ...
  "compute_tlfb_totdose_sum()", trans_uni("<U+2713>"), trans_uni("<U+2713>"), trans_uni("<U+2713>"), trans_uni("<U+2713>"), trans_uni("<U+2713>"), trans_uni("<U+2713>"), NA,
